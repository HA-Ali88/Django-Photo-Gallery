# Generated by Django 4.2.10 on 2024-03-18 05:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created'],
                'indexes': [models.Index(fields=['-created'], name='actions_act_created_ee97f6_idx'), models.Index(fields=['target_ct', 'target_id'], name='actions_act_target__04f236_idx')],
            },
        ),
    ]
